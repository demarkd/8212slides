...
Let $x\in A$ be a nonzero divisor and $(\psi,\phi)$ a matrix factorization of $x$.
\begin{itemize}
	\item<2-> We can construct a minimal $B=A/\idl{x}$-free resolution $\rF(\psi,\phi)$ of $\mathrm{coker }\phi$ with differentials $\phi,\psi$.$$\begin{tikzcd}[column sep=small,ampersand replacement=\#]\rF(\psi,\phi): \dots \ar[r,"\psi"]\# F\ar[r,"\phi"] \# G\ar[r,"\psi"]\# F\ar[r,"\phi"]\# G \ar[r]\# 0\end{tikzcd}$$   \note{Of course this res is periodic of period 2}.
	\item<3->
\end{itemize}
}
%
